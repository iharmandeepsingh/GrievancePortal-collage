      ...
      <nav className="navbar">
        <ul>
          <li className="admin-nav-title">
            <span>Accounts Grievances</span>
          </li>
          {/* Add a link style if this is a route */}
          {/* <li><Link to="/admin/accounts/reports">Reports</Link></li> */}
        </ul>
      </nav>
        ...
        <div className="card">
          ...
          {grievances.length === 0 ? (
            <div className="empty-state">
              <p>No grievances found for the Accounts Department.</p>
            </div>
          ) : (
