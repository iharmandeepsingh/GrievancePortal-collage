...
function Accounts() {
  ...
  const currentCategory = "accounts";
  ...
  // ✅ Route protection (assuming this is a student page)
  useEffect(() => {
  ...
  const validateForm = () => {
    ...
    // Note: 'message' is optional in your original code
    ...
    try {
      const res = await fetch("http://localhost:5000/api/grievances", {
        ...
        body: JSON.stringify({
          ...
          school: "Accounts Department", // Hardcoded as in your original file
          category: "Accounts",
      ...
      <main className="dashboard-body">
        <div className="card">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button typeT="submit" className="submit-btn">
              Submit Grievance
            </button>
          </form>
        </div>
